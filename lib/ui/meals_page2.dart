...
class MealPage extends StatelessWidget {
  MealPage(this.restaurantDocument);
  ...
  **/
  ...
  Widget build(BuildContext context) {
    ...
    **/
    ...
    var meals = Firestore.instance.collection('meal').where('restaurant_id', isEqualTo:restaurantDocument.documentID).snapshots();
    print("###################");
    print("###################");
    print("###################");
    print(restaurantDocument.documentID);
    int totalCount = 0;
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Text(
                                                    "Price: ₦"+document['normal_price'].toString()),
                                                SizedBox(
                                                  height: 4.0,
                                                ),
