    ...
    return Scaffold(
      ...
      body: !isLoading?ListView(children: <Widget>[
        ...
        Padding(
          ...
          child: Row(
            children: [
              Text("Featured", style: TextStyle(fontSize: 20, color: Color.fromRGBO(128, 0, 128, 1), fontWeight: FontWeight.bold),),
            ],
          ),
        ),
        CarouselSlider(
        ...
        Padding(
          ...
          child: Row(
            children: [
              Text("Restaurants", style: TextStyle(fontSize: 20, color: Color.fromRGBO(128, 0, 128, 1), fontWeight: FontWeight.bold),),
            ],
          ),
        ),
